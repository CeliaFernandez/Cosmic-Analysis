...
config.General.requestName = 'crab_CosmicPPreco_CosmicDTLocalReco'
...
config.JobType.psetName = 'CosmicPPreco_CosmicDTLocalReco_RAW2DIGI_L1Reco_RECO.py'
...
config.Data.outputDatasetTag = 'CosmicPPreco-CosmicDTLocalReco'
